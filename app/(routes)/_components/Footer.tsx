    ...
    return (
        <>
            <footer className='text-center border-t flex flex-col px-20 xl:px-40'>
                <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 py-16 justify-end items-start gap-y-12'>
            ...
            <Link href={"https://www.mertkocak.online/"} className='border-t py-6 text-center flex flex-col hover:text-orange-500 px-20 xl:px-40 text-gray-700 font-semibold text-sm'>Developed by Mert Koçak</Link>
        </>
    )
}
